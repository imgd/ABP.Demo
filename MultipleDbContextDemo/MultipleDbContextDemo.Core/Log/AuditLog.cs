...
namespace Abp.Auditing
{
    ...
    /// </summary>
    [Table("__AuditLog")]
    public class AuditLog : Entity<int>, IMayHaveTenant
    {
        /// <summary>
        /// Maximum length of <see cref="ServiceName"/> property.
        /// </summary>
        public const int MaxServiceNameLength = 250;

        /// <summary>
        /// Maximum length of <see cref="MethodName"/> property.
        /// </summary>
        public const int MaxMethodNameLength = 250;
        ...
        /// </summary>
        public const int MaxClientNameLength = 250;

        /// <summary>
        /// Maximum length of <see cref="BrowserInfo"/> property.
        /// </summary>
        public const int MaxBrowserInfoLength = 250;
        ...
        /// </summary>
        [MaxLength(MaxClientNameLength)]
        public virtual string ClientRefererUrl { get; set; }
        ...
        [MaxLength(50)]
        public virtual string ExceptionKey { get; set; }
        ...
        {
            var exception = auditInfo.Exception != null ? auditInfo.Exception.ToString() : null;
            return new AuditLog
            {
                ...
                ClientUrl = WebRequestExtesion.GetCurrentClientUrl(),
                ClientRefererUrl = WebRequestExtesion.GetCurrentClientUrlReferrer(),
                BrowserInfo = auditInfo.BrowserInfo.TruncateWithPostfix(MaxBrowserInfoLength),
                ExceptionKey = auditInfo.ExecutionTime.ToString("yyyyMMddHHmmss"),
                Exception = exception.TruncateWithPostfix(MaxExceptionLength),
